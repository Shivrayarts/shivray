  ...
  head: () => ({
    meta: [
      { title: "Login - Shivray" },
      {
        name: "description",
        content:
          "Customer login page designed for a simple, mobile-first Shivray experience.",
      },
    ],
  }),
});
...
function LoginPage() {
  ...
  function handleGoogleSignIn() {
    if (!googleClientId) {
      setGoogleMessage("Add VITE_GOOGLE_CLIENT_ID in your environment to enable Google sign-in.");
      return;
    }
    ...
    if (!google?.accounts?.id) {
      setGoogleMessage("Google sign-in is still loading. Please try again.");
      return;
    }
      ...
      <section className="bg-[#2b130c] px-4 pb-8 pt-6 text-white md:px-6 md:pb-12 md:pt-10">
        <div className="layout-shell">
          ...
          <h1 className="mt-4 font-heading text-4xl leading-none text-[#fff5e6] md:text-6xl">
            A cleaner login screen for mobile customers.
          </h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[#f4e7d8] md:text-base">
            This keeps login simple, touch-friendly, and visually aligned with the new
      ...
      <section className="px-4 pt-6 md:px-6">
        <div className="layout-shell grid gap-6 md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="mt-5 space-y-4">
            <Link
              to="/products"
              className="flex items-center justify-between rounded-[24px] border border-[#eadbc8] bg-[#fff9f2] p-4 transition hover:bg-[#fff3e0]"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#34180e]">Continue shopping</p>
            ...
            {[
              ...
              {
                icon: LockKeyhole,
                title: "Ready for future auth",
                text: "This gives us a polished customer-facing login page before deeper account flows.",
              },
            ].map((item) => (
          ...
          <div className="mx-auto max-w-md">
            ...
            <form className="mt-6 space-y-4" onSubmit={(event) => event.preventDefault()}>
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-[#eadbc8] bg-[#fcf8f2] py-3 pl-11 pr-4 text-sm text-[#34180e] outline-none transition placeholder:text-[#927863] focus:border-[#d6a35c] focus:bg-white"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-full border border-[#eadbc8] bg-white px-5 py-3 text-sm font-semibold text-[#34180e] transition hover:bg-[#fcf8f2]"
              >
            ...
            <div className="mt-4 rounded-[24px] border border-[#eadbc8] bg-[#fcf8f2] p-4 text-sm text-[#7e624b]">
              <p className="font-semibold text-[#34180e]">Account style from the reference</p>
              <p className="mt-2 leading-6">
                Login is now treated as a storefront account action, and the header also
                exposes `Account` beside cart for quicker access.
              </p>
            </div>
            ...
            <div className="mt-5 flex flex-col gap-3 text-center text-sm text-[#7e624b]">
              ...
              <Link to="/admin-login" className="transition hover:text-[#34180e]">
                Admin login
              </Link>
            </div>
          </div>
