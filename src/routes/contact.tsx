...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact - Shivray" },
      {
        name: "description",
        content:
          "Contact Shivray for product enquiries, catalogue requests, and quick mobile support.",
      },
      { property: "og:title", content: "Contact - Shivray" },
      {
        property: "og:description",
        content:
          "Fast mobile-first contact page for calls, WhatsApp, email, and custom orders.",
      },
    ],
  }),
});
...
function ContactPage() {
  ...
  const whatsappLink = useMemo(() => {
    const query = encodeURIComponent(
      `Hi Shivray, I am ${form.name || "interested in your products"}. ${
      ...
      <section className="bg-[#2b130c] px-4 pb-8 pt-6 text-white md:px-6 md:pb-12 md:pt-10">
        <div className="layout-shell">
          ...
          <h1 className="mt-4 font-heading text-4xl leading-none text-[#fff5e6] md:text-6xl">
            Simple contact options for mobile users.
          </h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[#f4e7d8] md:text-base">
            Customers should be able to call, WhatsApp, or leave a quick enquiry without
            friction. This page keeps those actions visible and easy to tap.
          </p>
        </div>
      </section>
        ...
        <div className="layout-shell grid gap-6 md:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="mt-5 space-y-5">
            <div className="rounded-[24px] bg-[#fcf7f0] p-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#34180e]">Call us</p>
                  <a
                    href={`tel:${siteConfig.phoneHref}`}
                    className="mt-1 inline-block text-sm text-[#7e624b] transition hover:text-[#34180e]"
                  >
            ...
            <div className="rounded-[24px] bg-[#fcf7f0] p-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#34180e]">Email us</p>
                  <a
            ...
            <div className="rounded-[24px] bg-[#fcf7f0] p-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#34180e]">Visit our studio</p>
                  <p className="mt-1 text-sm leading-6 text-[#7e624b]">
                    {siteConfig.address}
                  </p>
                </div>
              </div>
          ...
          <div className="mt-5 flex items-center gap-3">
            <a
              ...
              aria-label="Facebook"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#eadbc8] bg-white text-[#34180e] transition hover:bg-[#fcf7f0]"
            >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:brightness-105"
          >
          ...
          <h2 className="mt-2 font-heading text-3xl text-[#34180e]">
            Send a short message from your phone
          </h2>
          ...
          <form className="mt-6 space-y-4" onSubmit={(event) => event.preventDefault()}>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell us what you want to buy or ask for"
